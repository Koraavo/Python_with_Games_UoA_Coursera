...
outcomeline_2 = 'LOGIN FAILURE - TERMINAL LOCKED'
#         compute x coordinate
x_space = window.get_width() - window.get_string_width(outcomeline_2)
line_x = x_space // 2

window.draw_string(outcomeline_2, line_x, line_y)
window.update()
sleep(0.3)
line_y = line_y + string_height
